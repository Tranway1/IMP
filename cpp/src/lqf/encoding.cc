...
namespace lqf {
    namespace encoding {
        ...
        protected:
            ...
            void DumpBlock() {
                auto bit_width = arrow::BitUtil::Log2(dictionary_.size());
