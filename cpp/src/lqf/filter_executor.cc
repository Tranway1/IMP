...
namespace lqf {
    ...
    shared_ptr<Bitmap> FilterExecutor::executeSboost(Block &block, SboostPredicate<DTYPE> &predicate) {
        std::cout<<"executeSboost"<< std::endl;
        ...
        std::cout<<"finish lock key"<< std::endl;
        ...
        if (ite != regTable_.end()) {
            ...
            std::cout<<"finish iter pred"<< std::endl;
